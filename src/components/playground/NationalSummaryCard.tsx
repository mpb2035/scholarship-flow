    ...
    <div className="col-span-full bg-[hsl(210,80%,28%)] text-white rounded-3xl p-6 md:p-8 border-4 border-[hsl(210,20%,80%)] grid md:grid-cols-2 gap-6 items-center">
      <div>
        ...
        <div className="flex gap-8 md:gap-10">
          ...
          <div className="border-l border-white/30 pl-8 md:pl-10">
            ...
            <span
              className={
                stats.rank_change < 0 ? "text-red-300 font-semibold text-sm" : "text-green-300 font-semibold text-sm"
              }
            >
      ...
      <div className="text-right">
        ...
        <p className="text-white/80 mt-2">
          Score Delta:{" "}
          <span className={stats.score_change < 0 ? "text-red-300 font-bold" : "text-green-300 font-bold"}>
